    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-hyco.form-section submit="store">
                <x-slot name="title">
                    {{ __('Cash Account Information') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Update your cash account information.') }}
                </x-slot>
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-input-error class="mt-2" for="cash_id" />
                    </div>
                ...
                <x-slot name="actions">
                    <x-hyco.link href="{{ route('master.cash-account') }}" wire:navigate icon="x-mark" class="bg-yellow-500 hover:bg-yellow-400">Back</x-hyco.link>
