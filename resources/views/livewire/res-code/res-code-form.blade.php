    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-hyco.form-section submit="store">
                <x-slot name="title">
                    {{ __('ResCode Information') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Update your rescode information.') }}
                </x-slot>
                ...
                <x-slot name="actions">
                    <x-hyco.link href="{{ route('master.rescode') }}" wire:navigate icon="x-mark" class="bg-yellow-500 hover:bg-yellow-400">Back</x-hyco.link>
