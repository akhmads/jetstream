<div>
    ...
    <x-hyco.table>
        ...
        <x-slot name="headingRight">
            <x-hyco.link wire:navigate href="{{ route('cash_bank.cash.form',[$resource_type,0]) }}" icon="plus" class="">
                Create
            </x-hyco.link>
        </x-slot>
        ...
        <x-hyco.table-tr>
            ...
            <td class="h-px w-px whitespace-nowrap px-4 py-3">
                <a href="{{ route('cash_bank.cash.form',[$resource_type,$CashTrans->id]) }}" wire:navigate class="text-xs text-white bg-blue-600 px-3 py-1 rounded-lg">Edit</a>
