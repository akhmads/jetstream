<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $resource_type == 'in' ? __('Cash In') : __('Cash Out') }}
        </h2>
    </x-slot>
        ...
        <x-hyco.card>
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 md:col-span-3">
                    ...
                    @if(empty($code))
                    <x-hyco.select wire:model="prefix_code" :options="\App\Hyco\Code::list($resource_name)" class="w-full"></x-hyco.select>
                    @else
            ...
            <x-slot name="actions">
                ...
                <x-hyco.link href="{{ route('cash_bank.cash',[$resource_type]) }}" wire:navigate icon="arrow-left" class="bg-yellow-500 hover:bg-yellow-400">Back</x-hyco.link>
