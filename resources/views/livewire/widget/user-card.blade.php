<div>
    <div class="flex items-center px-5 py-4 bg-white border border-gray-300 rounded-lg shadow-xs dark:bg-gray-800 cursor-pointer hover:bg-slate-100 delay-50 duration-200 ease-in-out">
